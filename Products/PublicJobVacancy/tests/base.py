...
def setup_product():
    ...
    zcml.load_config('configure.zcml', Products.PublicJobVacancy)
    ...
    ztc.installPackage('Products.PublicJobVacancy')
...
setup_product()
ptc.setupPloneSite(products=['Products.PublicJobVacancy'])
